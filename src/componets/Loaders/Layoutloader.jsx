...
const Layoutloader = () => {
  return (
    <>
    <Box><Skeleton variant='rectangular' sx={{height:'4rem'}}></Skeleton></Box>
     <Grid container height={"calc(100vh-4rem)"} spacing={"1rem"}> 
          <Grid item sm={4} md={4} sx={{display:{xs:"none" , sm:"block"}}}><Skeleton variant='rectangular' height={"100vh"}/></Grid>
